...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-4 bg-white rounded-2xl border shadow-sm", className)}
      classNames={{
        ...
        day_selected:
          "bg-blue-900 text-slate-50 hover:bg-blue-900 hover:text-slate-50 focus:bg-blue-900 focus:text-slate-50",
